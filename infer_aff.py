...
if __name__ == '__main__':
    ...
    # parser.add_argument("--weights", default="/usr/volume/WSSS/Aff_f22_RLL_only_neutral_/save_checkpoints_aff/cam_pml/4_24.pth", type=str)
    # parser.add_argument("--out_rw", default='./out_pseudo_labels_neutral/train_aug/4_24/8_6_crf/', type=str)
    # parser.add_argument("--cam_dir", default="/usr/volume/WSSS/WSSS_PML_origin/out_cam", type=str)

    parser.add_argument("--weights", default="/usr/volume/WSSS/WSSS_PML_origin/saved_checkpoints_aff/4_24.pth", type=str)
    parser.add_argument("--out_rw", default='./out_pseudo_labels_alpha/train/4_24/8_6_6/', type=str)
    parser.add_argument("--cam_dir", default="/usr/volume/WSSS/WSSS_PML_origin/out_cam", type=str)
    # #
    # parser.add_argument("--weights", default="/usr/volume/WSSS/weights_released/res38_aff.pth", type=str)
    # parser.add_argument("--out_rw", default='./out_pseudo_labels/train/cam/rw_bg_19', type=str)
    # parser.add_argument("--cam_dir", default="/usr/volume/WSSS/psa/out_cam_train_ori", type=str)
    ...
    # parser.add_argument("--infer_list", default="/usr/volume/WSSS/psa/voc12/val.txt", type=str)
    parser.add_argument("--num_workers", default=16, type=int)
    parser.add_argument("--voc12_root", default='/usr/volume/WSSS/VOCdevkit/VOC2012/VOC2012', type=str)
    ...
    parser.add_argument("--bg_threshold", default=0.19, type=int)
