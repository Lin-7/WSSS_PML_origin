...
def eval(voc_list_txt, pred_dir, gt_dir='/usr/volume/WSSS/VOCdevkit/VOC2012/SegmentationClass',
    ...
    loglist = do_python_eval(pred_dir, gt_dir, name_list, num_class,)
    writelog(saved_txt, loglist, model_name)


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("--predict_dir", default='/usr/volume/WSSS/WSSS_PML_origin/out_pseudo_labels_alpha/train/4_24/8_6_6', type=str)

    parser.add_argument("--list", default='/usr/volume/WSSS/WSSS_PML_origin/voc12/train.txt', type=str)
