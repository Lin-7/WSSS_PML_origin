...
if __name__ == '__main__':
    ...
    parser.add_argument("--weights", default="/usr/volume/WSSS/weights_released/ilsvrc-cls_rna-a1_cls1000_ep-0001.params", type=str)
    ...
    parser.add_argument("--session_name", default="4_24", type=str)
    ...
    os.makedirs("./saved_checkpoints_aff/", exist_ok=True)
    save_dir = os.path.join("./saved_checkpoints_aff/", args.session_name + '.pth')
